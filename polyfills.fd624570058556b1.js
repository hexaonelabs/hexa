(self["webpackChunkbrowser"] = self["webpackChunkbrowser"] || []).push([[6429],{

/***/ 87390:
/*!***************************************!*\
  !*** ./apps/browser/src/polyfills.js ***!
  \***************************************/
...
/* harmony import */ var share_api_polyfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! share-api-polyfill */ 88122);
/* harmony import */ var share_api_polyfill__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(share_api_polyfill__WEBPACK_IMPORTED_MODULE_2__);
/**
...
(() => {
  ...
  function n(n) {
    for (var o = 1; o < arguments.length; o++) {
      ...
      o % 2 ? e(Object(a), !0).forEach(function (e) {
        t(n, e, a[e]);
  ...
  navigator.share = navigator.share || function () {
    var e = {
      ...
      o = navigator.userAgent.match(/iPhone|iPad|iPod/i),
    ...
    return function () {
      ...
      return new Promise(function (s, r) {
        t.title && "string" == typeof t.title && t.text && "string" == typeof t.text || r("Invalid Params");
        var p = t.title,
          d = t.url,
          h = t.fbId,
          m = t.hashtags,
          ...
          w = n(n({}, e.default), e[y.language] ? e[y.language] : e[navigator.language] || e[navigator.language.substr(0, 2).toLowerCase()] || e.en),
          u = t.text || p,
          f = encodeURIComponent(t.image);
        function b() {
          k.classList.remove("visible"), P.classList.remove("visible"), k.addEventListener("transitionend", function e() {
            k.removeEventListener("transitionend", e), document.body.removeChild(k);
          }), P.addEventListener("transitionend", function e() {
            P.removeEventListener("transitionend", e), document.body.removeChild(P), document.head.removeChild(document.querySelector("#shareAPIPolyfill-style")), document.removeEventListener("keyup", x);
          });
        }
        ...
        k.id = "shareAPIPolyfill-backdrop", P.id = "shareAPIPolyfill-container", P.setAttribute("tabindex", "0"), P.innerHTML = '\n<div class="shareAPIPolyfill-header">\n <div class="shareAPIPolyfill-header-title" tabindex="0">'.concat(c.share, " ").concat(w.shareTitle, '</div>\n <div class="shareAPIPolyfill-icons-container title">\n  <button class="').concat(y.copy ? "" : "hidden", ' tool-icon copy" data-tool="copy">\n   ').concat(c.copy, '\n   <span class="the-icon-title">').concat(w.copy, '</span>\n  </button>\n  <button class="').concat(y.print ? "" : "hidden", ' tool-icon print" data-tool="print">\n   ').concat(c.print, '\n   <span class="the-icon-title">').concat(w.print, '</span>\n  </button>\n  <button class="').concat(y.email ? "" : "hidden", ' tool-icon email" data-tool="email">\n   ').concat(c.email, '\n   <span class="the-icon-title">').concat(w.email, '</span>\n  </button>\n  <button class="').concat(y.sms ? "" : "hidden", ' tool-icon sms" data-tool="sms">\n   ').concat(c.sms, '\n   <span class="the-icon-title">').concat(w.sms, '</span>\n  </button>\n </div>\n</div>\n<div class="shareAPIPolyfill-body">\n <div class="shareAPIPolyfill-icons-container body">\n  ').concat(h ? '\n   <button class="tool-icon messenger '.concat(y.messenger ? "" : "hidden", '" data-tool="messenger">\n    ').concat(c.messenger, '\n    <span class="the-icon-title">').concat(w.messenger, "</span>\n   </button>\n  ") : "", '\n  <button class="').concat(y.facebook ? "" : "hidden", ' tool-icon facebook" data-tool="facebook">\n   ').concat(c.facebook, '\n   <span class="the-icon-title">').concat(w.facebook, '</span>\n  </button>\n  <button class="').concat(y.whatsapp ? "" : "hidden", ' tool-icon whatsapp" data-tool="whatsapp">\n   ').concat(c.whatsapp, '\n   <span class="the-icon-title">').concat(w.whatsapp, '</span>\n  </button>\n  <button class="').concat(y.twitter ? "" : "hidden", ' tool-icon twitter" data-tool="twitter">\n   ').concat(c.twitter, '\n   <span class="the-icon-title">').concat(w.twitter, '</span>\n  </button>\n  <button class="').concat(y.linkedin ? "" : "hidden", ' tool-icon linkedin" data-tool="linkedin">\n   ').concat(c.linkedin, '\n   <span class="the-icon-title">').concat(w.linkedin, '</span>\n  </button>\n  <button class="').concat(y.telegram ? "" : "hidden", ' tool-icon telegram" data-tool="telegram">\n   ').concat(c.telegram, '\n   <span class="the-icon-title">').concat(w.telegram, '</span>\n  </button>\n  <button class="').concat(y.skype ? "" : "hidden", ' tool-icon skype skype-share" data-tool="skype" data-href="').concat(d, '" data-text="').concat(p + ": " + d, '">\n   ').concat(c.skype, '\n   <span class="the-icon-title">').concat(w.skype, '</span>\n  </button>\n  <button class="').concat(y.pinterest ? "" : "hidden", ' tool-icon pinterest" data-tool="pinterest">\n   ').concat(c.pinterest, '\n   <span class="the-icon-title">').concat(w.pinterest, '</span>\n  </button>\n </div>\n <button class="shareAPIPolyfill-footer">\n  ').concat(w.cancel, "\n </button>\n</div>\n"), k.addEventListener("click", function () {
          b();
        }), !1 !== y.skype && function (e, n, t) {
          e.loadSkypeWebSdkAsync = e.loadSkypeWebSdkAsync || function (e) {
            var o,
              a = n.getElementsByTagName(t)[0];
            n.getElementById(e.id) || ((o = n.createElement(t)).id = e.id, o.src = e.scriptToLoad, o.onload = e.callback, a.parentNode.insertBefore(o, a));
          };
          e.loadSkypeWebSdkAsync({
            scriptToLoad: "https://swx.cdn.skype.com/shared/v/latest/skypewebsdk.js",
            id: "skype_web_sdk"
          });
        }(window, document, "script"), requestAnimationFrame(function (e) {
          document.body.appendChild(k), document.body.appendChild(P), document.addEventListener("keyup", x), Array.from(P.querySelectorAll(".tool-icon")).forEach(function (e) {
            e.addEventListener("click", function (n) {
              var o = encodeURIComponent(u + ": " + d);
              switch (e.dataset.tool) {
                case "copy":
                  navigator.clipboard.writeText("".concat(p, "\n").concat(t.text || "", "\n").concat(d));
                  break;
                case "print":
                  ...
                  break;
                case "email":
                  var a = "".concat(encodeURIComponent(u), "%0D%0A"),
                    c = "mailto:?subject=".concat(p, "&body=").concat(a).concat(encodeURIComponent(d));
                  window.open(c);
                  break;
                case "sms":
                  location.href = "sms:".concat(w.selectSms, "?&body=").concat(encodeURIComponent(p), ": ").concat(encodeURIComponent(t.text || ""), " ").concat(d);
                  break;
                case "messenger":
                  window.open("http://www.facebook.com/dialog/send?app_id=" + h + "&display=popup&href=" + encodeURIComponent(d) + "&link=" + encodeURIComponent(d) + "&redirect_uri=" + encodeURIComponent(d) + "&quote=" + encodeURIComponent(u));
                  break;
                case "facebook":
                  window.open("https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(d) + "&quote=" + encodeURIComponent(u) + "&hashtag=" + (v || m || ""));
                  break;
                case "whatsapp":
                  window.open((i ? "https://api.whatsapp.com/send?text=" : "whatsapp://send?text=") + encodeURIComponent(u + "\n" + d));
                  break;
                case "twitter":
                  window.open("https://twitter.com/intent/tweet?text=".concat(encodeURIComponent(u), "&url=").concat(encodeURIComponent(d), "&hashtags=").concat(m || "", "&via=").concat(g ? encodeURIComponent(g) : ""));
                  break;
                case "linkedin":
                  window.open("https://www.linkedin.com/shareArticle?mini=true&url=".concat(encodeURIComponent(d), "&title=").concat(p, "&summary=").concat(u, "&source=LinkedIn"));
                  break;
                case "telegram":
                  window.open(i ? "https://telegram.me/share/msg?url=" + encodeURIComponent(d) + "&text=" + encodeURIComponent(u) : "tg://msg?text=" + o);
                  break;
                case "pinterest":
                  window.open("https://pinterest.com/pin/create/button/?url=" + encodeURIComponent(d) + "&description=" + encodeURIComponent(u) + "&media=" + f);
              }
              s(), b();
            });
          }), P.querySelector(".shareAPIPolyfill-footer").addEventListener("click", b), requestAnimationFrame(function () {
            k.classList.add("visible"), P.classList.add("visible");
...
/******/ var __webpack_exports__ = (__webpack_exec__(87390));
/******/ }
]);
//# sourceMappingURL=polyfills.fd624570058556b1.js.map